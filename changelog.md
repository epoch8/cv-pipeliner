...
- `visualize_image_data` respects COCO `keypoints_visibility` (skip unlabeled, outline occluded, fill visible) and can draw `keypoints_scores` via `include_keypoint_scores=True`.
