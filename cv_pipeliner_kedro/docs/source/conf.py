...
# cv_pipeliner_kedro documentation build
...
from cv_pipeliner_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "cv_pipeliner_kedro"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "cv_pipeliner_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "cv_pipeliner_kedro.tex",
        "cv_pipeliner_kedro Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "cv_pipeliner_kedro",
        "Project cv_pipeliner_kedro codebase.",
        "Data-Science",
    )
]
