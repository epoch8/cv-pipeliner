...
def get_detection_model_spec(cfg: _cfg) -> DetectionModelSpec:
...
def get_classification_model_spec(cfg: _cfg) -> ClassificationModelSpec:
    ...
    return classification_model_spec
