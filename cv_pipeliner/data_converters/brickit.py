...
class BrickitDataConverter(DataConverter):
    def get_annot_from_image_data(self, image_data: ImageData) -> Dict:
        annot = {"filename": image_data.image_name, "objects": []}
        ...
        for bbox_data in image_data.bboxes_data:
            ...
            obj = {
                ...
                **(
                    {key: bbox_data_json["additional_info"][key] for key in bbox_data_json["additional_info"]}
                    if "additional_info" in bbox_data_json
                    else {}
                ),
            }
    ...
    def get_images_data_from_annots(
        self, images_dir: Union[str, Path, fsspec.core.OpenFile], annots: Union[Path, str, Dict, fsspec.core.OpenFile]
    ) -> List[ImageData]:
