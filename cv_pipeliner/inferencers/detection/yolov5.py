...
class YOLOv5_ModelSpec(DetectionModelSpec):
    ...
    @property
    def runtime_cls(self) -> Type["YOLOv5Runtime"]:
        from cv_pipeliner.inferencers.detection.yolov5 import YOLOv5Runtime

        return YOLOv5Runtime
...
class YOLOv5Runtime(DetectionRuntime):
    @contextmanager
