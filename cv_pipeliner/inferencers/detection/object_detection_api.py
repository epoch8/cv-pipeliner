...
class ObjectDetectionAPI_ModelSpec(DetectionModelSpec):
    ...
    @property
    def runtime_cls(self) -> Type["ObjectDetectionAPIRuntime"]:
        from cv_pipeliner.inferencers.detection.object_detection_api import (
            ObjectDetectionAPIRuntime,
        )

        return ObjectDetectionAPIRuntime
...
class ObjectDetectionAPIRuntime(DetectionRuntime):
