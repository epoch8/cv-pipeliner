...
from cv_pipeliner.inferencers.keypoints_regressor.utils.mmpose_utils import (
    bbox_xywh2cs,
...
class MMPose_KeypointsRegressorModelSpec_TFLite(KeypointsRegressorModelSpec):
    ...
    @property
    def runtime_cls(self) -> Type["MMPoseKeypointsRegressorRuntime"]:
        from cv_pipeliner.inferencers.keypoints_regressor.mmpose import (
            MMPoseKeypointsRegressorRuntime,
        )

        return MMPoseKeypointsRegressorRuntime
...
class MMPoseKeypointsRegressorRuntime(KeypointsRegressorRuntime):
    ...
    def __init__(self, model_spec: MMPose_KeypointsRegressorModelSpec_TFLite):
        ...
        if isinstance(model_spec, MMPose_KeypointsRegressorModelSpec_TFLite):
            ...
            raise ValueError(
                f"MMPoseKeypointsRegressorRuntime got unknown MMPose_KeypointsRegressorModelSpec: {type(model_spec)}"
            )
