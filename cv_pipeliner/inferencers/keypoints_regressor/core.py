...
class KeypointsRegressorModelSpec(ModelSpec):
    ...
    def load_keypoints_regressor_inferencer(self) -> "KeypointsRegressorInferencer":
        return KeypointsRegressorInferencer(self.load_runtime())


class KeypointsRegressorRuntime(Runtime):
...
class KeypointsRegressorInferencer(Inferencer):
    def __init__(self, runtime: KeypointsRegressorRuntime):
...
KeypointsRegressorRuntime = KeypointsRegressorRuntime
