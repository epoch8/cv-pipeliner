    ...
    for tag, tag_image_data in [
        ...
        for tag_bbox_data_matching in image_data_matching.bboxes_data_matchings:
            ...
            tag_bbox_data_with_visualized_label = BboxData(
                ...
                keypoints=tag_bbox_data.keypoints,
                keypoints_visibility=tag_bbox_data.keypoints_visibility,
                keypoints_scores=tag_bbox_data.keypoints_scores,
                keypoints_labels=tag_bbox_data.keypoints_labels,
                mask=tag_bbox_data.mask,
            )
        ...
        tag_image_data_with_visualized_labels = ImageData(
            ...
            keypoints=tag_image_data.keypoints,
            keypoints_visibility=tag_image_data.keypoints_visibility,
            keypoints_scores=tag_image_data.keypoints_scores,
            keypoints_labels=tag_image_data.keypoints_labels,
            mask=tag_image_data.mask,
            label=tag_image_data.label,
        )
        if tag == "true":
...
def visualize_image_data_matching_side_by_side(
    ...
    true_include_keypoints: bool = False,
    pred_include_keypoints: bool = False,
    true_include_keypoint_scores: bool = False,
    pred_include_keypoint_scores: bool = False,
    true_include_keypoints_labels: bool = False,
    pred_include_keypoints_labels: bool = False,
    true_include_keypoints_visibility: bool = True,
    pred_include_keypoints_visibility: bool = True,
    true_keypoints_radius: Optional[int] = None,
    pred_keypoints_radius: Optional[int] = None,
    fontsize: int = 24,
    ...
    true_image = visualize_image_data(
        ...
        keypoints_radius=true_keypoints_radius if true_keypoints_radius is not None else keypoints_radius,
        include_additional_bboxes_data=include_additional_bboxes_data,
        additional_bboxes_data_depth=additional_bboxes_data_depth,
        include_keypoints=true_include_keypoints,
        include_keypoint_scores=true_include_keypoint_scores,
        include_keypoints_labels=true_include_keypoints_labels,
        include_keypoints_visibility=true_include_keypoints_visibility,
        fontsize=fontsize,
    ...
    pred_image = visualize_image_data(
        ...
        mask_alpha=mask_alpha,
        draw_base_labels_with_given_label_to_base_label_image=draw_base_labels_with_given_label_to_base_label_image,
        keypoints_radius=pred_keypoints_radius if pred_keypoints_radius is not None else keypoints_radius,
        include_additional_bboxes_data=include_additional_bboxes_data,
        additional_bboxes_data_depth=additional_bboxes_data_depth,
        include_keypoints=pred_include_keypoints,
        include_keypoint_scores=pred_include_keypoint_scores,
        include_keypoints_labels=pred_include_keypoints_labels,
        include_keypoints_visibility=pred_include_keypoints_visibility,
        fontsize=fontsize,
        keypoints_fontsize=keypoints_fontsize,
        thickness=thickness,
        thumbnail_size=thumbnail_size,
