...
def visualize_images_data_with_overlay(
    ...
    image1 = visualize_image_data(
        image_data=image_data1, include_labels=True, include_keypoints=include_keypoints
    )
    image2 = visualize_image_data(
        image_data=image_data2, include_labels=True, include_keypoints=include_keypoints
    )
